      ...
      <div class="col-sm-9">
        ...
        <div class="comment">
          <ul class="comment_list">
            <li><font color="#1ca8dd"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></font>
可以正常上课且有题集和作业</li>
            <li><font color="#9f86ff"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></font>
可以正常上课但没有题集或作业</li>
            <li><font color="#e64759"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></font>
不能正常上课</li>
            <li><font color="#e4d836"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></font>
已下课但不能看回放</li>
            <li><font color="#1bc98e"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></font>
已下课能并且可以看回放</li>
          </ul>
        </div> <!-- comment -->
      </div>
